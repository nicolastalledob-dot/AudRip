...
export default function VinylDisc3D({ src, artist, album, color, className = 'cover-art-3d', isPlaying }: VinylDisc3DProps) {
    ...
    useEffect(() => {
        ...
        // Tilt ~15° toward camera
        group.rotation.x = 1.25

        // Disc body
        const discGeometry = new THREE.CylinderGeometry(0.85, 0.85, 0.03, 64)
        ...
        const labelGeometry = new THREE.CircleGeometry(labelRadius, 64)
        ...
        const backLabelGeometry = new THREE.CircleGeometry(labelRadius, 64)
        ...
        // Center hole (spindle)
        const holeGeometry = new THREE.CylinderGeometry(0.04, 0.04, 0.04, 32)
        ...
        const turntableSpeed = 0.012 // slow turntable spin
        ...
        const animate = () => {
            ...
            if (resetting) {
                ...
                if (isPlayingRef.current) {
                    group.rotateOnWorldAxis(worldY, turntableSpeed * dt)
                }
