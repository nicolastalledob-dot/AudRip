...
export default function CD3D({ src, className = 'cover-art-3d', isPlaying }: CD3DProps) {
    ...
    useEffect(() => {
        ...
        const frontGeometry = new THREE.CircleGeometry(outerRadius, 64)
        ...
        const backGeometry = new THREE.CircleGeometry(outerRadius, 64)
        ...
        const outerEdgeGeometry = new THREE.CylinderGeometry(outerRadius, outerRadius, discThickness, 64, 1, true)
        ...
        const innerEdgeGeometry = new THREE.CylinderGeometry(holeRadius, holeRadius, discThickness, 32, 1, true)
        ...
        const animate = () => {
            ...
            if (resetting) {
                ...
                if (isPlayingRef.current) {
                    group.rotateOnWorldAxis(worldY, spinSpeed * dt)
                }
